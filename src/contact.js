    ...
    render() {
        return (
            <div className="contact">
                ...
                <h3 className="contact-text">If you have any questions about my <a className="resume" href="#">resume</a>, or just want to grab coffee. I would love to hear from you.</h3>
